...
从维护者 ROM 归档只读提取；原始 NAS 文件未修改。对应原厂 boot 仅保存在本地工作目录，仓库提交提取的内核配置、来源 URL 和哈希。

| 机型 | ColorOS | OxygenOS | 状态 |
| --- | --- | --- | --- |
| OnePlus 8 Pro | IN2020_13.1.0.190(CN01) | 13.1.0.591 待取得 | 编译验证中；未真机验证 |
...
源码分支与原厂版本接近不意味着 vendor 模块 CRC 已验证。首轮已定位并修复厂商源码依赖与三个旧式函数原型问题，下一轮使用原厂配置构建。
